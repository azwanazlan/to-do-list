                        ...
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" onclick="markAsCompleted({{ $content->id }})"href="#"><i class="fa fa-check p-2"></i>Mark as Completed</a></li>
                                  {{-- <li><a class="dropdown-item" href="{{route('mark', $content->id) }}"href="#">Mark as Completed</a></li> --}}
                                  <li><hr class="dropdown-divider"></li>
                                  <li><a class="dropdown-item" onclick="destroy({{ $content->id }})" href="#"><i class="fa fa-trash p-2"></i>Delete</a></li>
                                </ul>
                              </div>
